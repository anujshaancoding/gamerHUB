...
const updates: UpdateEntry[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Fixed the landing-page menu overflowing/clipping on tablet-width screens",
    ],
  },
  {
  ...
  },
  {
    ...
    version: "1.39.0",
    type: "feature",
    title: "Valorant Passport launch flow",
    description:
      "ggLobby now has a Passport-first entry point for Indian Valorant players, making it easier to create a share-ready identity before Squad Finder fully opens.",
    highlights: [
      "New /passport page lets players preview a Valorant identity with rank, peak rank, main agent, role, state, language and playstyle",
      "Passport can now be saved to a profile, staged through signup and downloaded as a shareable PNG for Instagram, WhatsApp, Discord and X",
      "Passport save, share and download actions now feed first-party funnel analytics so we can measure which actions convert players",
      "New /passport/gallery page turns saved public Passports into a browseable recognition layer, with weekly feature submissions for early Indian Valorant players",
      "The overview page now shows live Passport proof cards so new visitors can see the community forming before Squad Finder opens",
      "Rank Card now supports role, main agent, peak rank, three visual templates and clear source labels for manual versus career-record cards",
      "The public overview page now leads with Valorant Passport and points players toward Rank Card, India Scene and Squad Finder early access",
      "LFG is no longer the first public promise - Squad Finder is positioned as an early-access layer that improves as more verified players join",
    ],
  },
  {
