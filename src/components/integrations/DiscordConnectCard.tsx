...
export function DiscordConnectCard({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="p-6 border-b border-border bg-gradient-to-r from-[#5865F2]/10 to-transparent">
        <div className="flex items-center gap-4">
          ...
          {status?.connected && status.discord_avatar_url && (
            <img
              ...
              alt={status.discord_username || "Discord"}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 pt-2 border-t border-border">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium">Auto-post LFG</div>
                  <div className="text-xs text-muted-foreground">
                    Share LFG posts to Discord
                  </div>
                </div>
                <Switch
                  checked={status.settings?.cross_post_lfg ?? false}
                  onCheckedChange={(checked) =>
                    updateSettings({ cross_post_lfg: checked })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium">Show Discord Status</div>
                  <div className="text-xs text-muted-foreground">
                    Display your Discord status on profile
                  </div>
                </div>
                <Switch
                  checked={status.settings?.show_discord_status ?? false}
                  onCheckedChange={(checked) =>
                    updateSettings({ show_discord_status: checked })
                  }
                />
              </div>
            </div>
