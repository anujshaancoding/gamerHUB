...
import { FriendPostCard } from "@/components/social/friends/friend-post-card";
...
import { SearchFilterBar } from "@/components/social/community/SearchFilterBar";
import type { CommunityListing } from "@/types/listings";

const TournamentsTab = dynamic(
  () => import("@/components/social/community/TournamentsTab").then((mod) => mod.TournamentsTab),
  {
    ssr: false,
    loading: () => (
...
const CreateListingModal = dynamic(
  () => import("@/components/social/community/CreateListingModal").then((mod) => mod.CreateListingModal),
  { ssr: false }
);

const ListingDetailModal = dynamic(
  () => import("@/components/social/community/ListingDetailModal").then((mod) => mod.ListingDetailModal),
  { ssr: false }
);
